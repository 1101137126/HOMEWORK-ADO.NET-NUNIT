...
<body>
    ...
    <div>
        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ASP20150327ConnectionString %>" SelectCommand="SELECT * FROM [Stduent]"></asp:SqlDataSource>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ASP20150327ConnectionString %>" SelectCommand="SELECT * FROM [Stduent]"></asp:SqlDataSource>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ASP20150327ConnectionString %>" SelectCommand="SELECT * FROM [Stduent]"></asp:SqlDataSource>
    </form>
</body>
</html>